...
# wps.res: SWMM/SWMM_project_original.inp, SWMM/demo_rain.dat;
...
# wps.in: id = demo, type = boolean,
# title = Demo-Modus, value=FALSE,
# abstract = wenn TRUE/1 wird Demo-Regen-File aus Resources/SWMM verwendet;
...
if(demo){
  ...
  file.copy(paste0(inp, ".out"), out_path, overwrite=T)
